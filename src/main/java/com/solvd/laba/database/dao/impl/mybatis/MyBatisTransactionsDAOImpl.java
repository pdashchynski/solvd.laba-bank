...
public class MyBatisTransactionsDAOImpl implements TransactionsDAO {

    private final MyBatisStaffDAOImpl jdbcStaffDAO = new MyBatisStaffDAOImpl();
    private final MyBatisServicesDAOImpl jdbcServicesDAO = new MyBatisServicesDAOImpl();
