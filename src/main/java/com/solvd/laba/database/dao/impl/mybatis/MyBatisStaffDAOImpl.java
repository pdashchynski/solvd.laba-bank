...
public class MyBatisStaffDAOImpl implements StaffDAO {

    private final MyBatisPersonsDAOImpl jdbcPersonsDAO = new MyBatisPersonsDAOImpl();
    private final MyBatisDepartmentsDAOImpl jdbcDepartmentsDAO = new MyBatisDepartmentsDAOImpl();
